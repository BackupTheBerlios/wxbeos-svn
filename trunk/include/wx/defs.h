...
typedef void * WXHWND;
typedef void * WXHANDLE;
typedef BBitmap * WXHICON;
//typedef unsigned long   WXHFONT;
//typedef unsigned long   WXHMENU;
//knorr??
typedef unsigned long   WXHPEN;
typedef unsigned long   WXHBRUSH;
typedef color_map   WXHPALETTE;
typedef BCursor * WXHCURSOR;
//typedef unsigned long   WXHRGN;
//typedef unsigned long   WXHACCEL;
typedef BBitmap * WXHBITMAP;
//typedef unsigned long   WXHDC;
//typedef unsigned int    WXUINT;
typedef unsigned long   WXDWORD;
typedef unsigned short  WXWORD;
//
typedef unsigned long   WXCOLORREF;
typedef BMessage          WXMSG;
//typedef unsigned long   WXHTREEITEM;
//knorr??
typedef void *          WXDRAWITEMSTRUCT;
typedef void *          WXMEASUREITEMSTRUCT;
typedef BMessage *          WXEVENTPTR;
//typedef void *          WXLPCREATESTRUCT;
//
//typedef BRegion *	WXRegion;
typedef WXHWND		WXWidget;
typedef BScreen		WXDisplay;
typedef rgb_color		WXColor;
typedef BWindow *		WXWindow;
typedef color_space		WXColormap;
typedef BMessage * 	WXEvent;
typedef BBitmap * 		WXPixmap;
#endif
